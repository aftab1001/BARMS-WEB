...
public partial class MasterPages_DepartmentAdminMaster : System.Web.UI.MasterPage
{
    int UserID;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["UserLogin"] != null)
        {
            ...
            UserID = user.UserID;
            ankMyAccount.HRef = "../DepartmentAdmin/MyAccount.aspx?id=" + ((SessionUser)Session["UserLogin"]).UserID;
        }
        if (!IsPostBack)
        {
            BindInBox();
