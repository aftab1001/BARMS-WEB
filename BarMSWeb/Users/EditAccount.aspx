<%@ Page Language="C#" MasterPageFile="~/MasterPages/UserMaster.master" AutoEventWireup="true"
    CodeFile="EditAccount.aspx.cs" Inherits="Users_EditAccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="graybox_account">
        ...
        <div class="centermiddle">
            <table border="0" cellspacing="0" cellpadding="0" class="width100percent">
                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" class="width100percent">
                            <tr>
                                <td class="width22percent align_center_top" style="height: 200px; text-align: left;">
                                        ...
                                        <tr>
                                            <td class="align_left_middle" colspan="2">
                                                <div class="old_password">
                                                    <asp:TextBox ID="txtOldPassword" Text="" runat="server" TextMode="password"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td class="align_left_middle" colspan="2">
                                                <div class="new_password">
                                                    <asp:TextBox ID="txtNewPassword" Text="" runat="server" TextMode="password"></asp:TextBox>
                                        ...
                                        <tr>
                                            <td class="align_left_middle" colspan="2">
                                                <div class="textbox_repassword">
                                                    <asp:TextBox ID="txtReNewPassword" Text="" runat="server" TextMode="password"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtReNewPassword"
                                                        ErrorMessage="*" ValidationGroup="Register"></asp:RequiredFieldValidator>
                                                         <asp:CompareValidator ID="compare1" runat="server" ControlToCompare="txtNewPassword"
                                                            ControlToValidate="txtReNewPassword" ErrorMessage="*" ValidationGroup="Register"></asp:CompareValidator>
                                                </div>
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                <td>
                                    <asp:FileUpload ID="fpUploadPic" runat="server" Width="100" />
                                </td>
                            </tr>
                        </table>
                    </td>
                            ...
                            <tr>
                                <td class="align_top">
                                    <table border="0" cellspacing="0" cellpadding="0" class="width100percent">
                                        ...
                                        <tr>
                                            <td class="width61percent">
                                                <div class="textbox204">
                                                    <asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>
                                                </div>
                                            </td>
                                            <td class="width39percent">
                                ...
                                <td class="align_top" style="width: 349px">
                                    <table border="0" cellspacing="0" cellpadding="0" class="width100percent">
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            <td class="width62percent">
                                                <div class="textbox204">
                                                    <asp:TextBox ID="txtMobile" runat="server"></asp:TextBox>
                                                </div>
                                            </td>
                                            <td class="width38percent">
                            ...
                            <tr>
                                <td class="align_top">
                                    ...
                                    <td colspan="2">
                                        ...
                                        <tr>
                                            <td class="width59percent">
                                                <div class="textbox204" style="display: none;">
                                                    <asp:DropDownList ID="ddlDepartments" runat="server" AutoPostBack="false" Visible="false">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                            <td class="width41percent">
                                                <asp:ImageButton ID="btnSendRequest" runat="server" ImageUrl="../images/btn_sendrequest.png"
                                                    Visible="false" OnClick="btnSendRequest_Click" />
                                            </td>
                                        </tr>
                                        <tr height="10">
                                            <td colspan="2">
                                ...
                                <td class="align_top">
                                    <table border="0" cellspacing="0" cellpadding="0" class="width100percent" style="width: 49%;">
                                        <tr>
                                            <td colspan="2">
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                        ...
                                        <tr>
                                            <td class="width61percent" style="width: 3%;">
                                                <div class="textbox204">
                                                    <asp:DropDownList ID="ddlSpeciality" runat="server" AutoPostBack="false">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                            <td class="width39percent" style="text-align: right;">
                ...
                <tr>
                    <td>
                        <table border="0" cellspacing="2" cellpadding="2" class="width100percent">
                            <tr>
                                <td>
                                    <table border="0" cellspacing="2" cellpadding="2" class="width100percent">
                                        <tr>
                                            <td>
                                                <table border="0" cellspacing="4" cellpadding="3" class="width100percent">
                                                    <tr>
                                                        <td class="label_bold">
                                                            First Name
                                                        </td>
        ...
        <div class="bottom_graybox_right">
            <asp:ImageButton ID="btnUpdate" runat="server" ImageUrl="../images/btn_update.png"
                ValidationGroup="Register" OnClick="btnUpdate_Click" />
        </div>
        <div class="clear_75">
        </div>
    </div>
    ...
    <div class="bottom_graybox_left">
        <img src="../images/back_arrow.png" alt="" /><a href="login.html">Back to Login Page</a></div>--%>
</asp:Content>
