<%@ Page Language="C#" MasterPageFile="~/MasterPages/UserMaster.master" AutoEventWireup="true"
    CodeFile="UserContract.aspx.cs" Inherits="Users_UserContract" Title="" %>
                        ...
                        <div class="graybox_big">
                            ...
                            <table style="width: 100%">
                                <tr>
                                    ...
                                    <td style="width: 241px;">
                                        <span style="float: left; margin-top: 5px; margin-left: 15px;">Till:</span><div class="textbox_small">
                                                        ...
                                                        <div style="border: #e7e7e7 1px solid; height: 100px;">
                                                            ...
                                                            <table id="tblSalary" runat="server" cellpadding="2" cellspacing="2">
                                                                <tr id="trScaled" runat="server" visible="false">
                                                                    ...
                                                                    <td class="label_bold align_left_middle">
                                                                        <span style="margin-top: 7px; float: left; font-weight: normal;">
                                                                            Low Season:</span>
                                                                    ...
                                                                    <td class="label_bold align_left_middle" colspan="2">
                                                                        <span style="margin-top: 7px; float: left; padding-left: 14px;
                                                                            font-weight: normal;">High Season:</span>
                                                                        <div class="textbox_small_2">
