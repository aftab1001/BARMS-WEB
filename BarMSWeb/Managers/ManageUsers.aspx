<%@ Page Language="C#" MasterPageFile="~/MasterPages/ManagerMaster.master" AutoEventWireup="true"
    CodeFile="ManageUsers.aspx.cs" Inherits="Managers_ManageUsers" %>
    ...
    <table cellpadding="2" cellspacing="2" border="0" width="100%">
        <tr>
            <td style="width: 150px;">
                ...
                <asp:LinkButton ID="lnkViewAll" runat="server" OnClick="lnkViewAll_Click" Visible="false" ForeColor="Blue">View All</asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td>
                            ...
                            <asp:GridView ID="grdUsers" runat="server" AutoGenerateColumns="false" AllowPaging="true"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Bonus" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgBtnBonus" runat="server" ImageUrl="~/Images/icon_b_greypng.png" CommandName="Bonus"
                                                CommandArgument='<%# Bind("pkUserID") %>' />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    
                                     <asp:TemplateField HeaderText="Contract" ItemStyle-Width="50px">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgBtnContract" runat="server" ImageUrl="~/Images/icon_c_red.png" OnClientClick="return false;"/>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                                    ...
                                                    <td>
                                                        <a id="ankFacebook" runat="server" href="<%#Bind('sFaceBookProfile') %>" target="_blank">
                                                            <img src="../Images/facebook_m.png" width="16" /></a> <a id="ankTwitter" runat="server"
                                                                ...
                                                                <img src="../Images/twitter_m.png" width="16" /></a> <a id="ankMsn" runat="server" onclick="return false;" 
                                                                    href="#" style="cursor:auto;">
                                                                    <img src="../Images/msn_m.png" width="16" /></a> <a id="ankSkype" runat="server" onclick="return false;"
                                                                        href="#" style="cursor:auto;">
                ...
                <tr>
                  ...
                  onkeypress="javascript:CorrectValue(this);" onchange="javascript:fixedDecimalPlace2(this);"></asp:TextBox>
                        ...
                        <span style="position: relative; float: left;font-weight:bold; left: 1px; line-height: 31px;">€</span>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" style="margin-left:-18px;float:left;" runat="server" ControlToValidate="txtBonusAmount"
                        ...
                        <div class="textboxmulti"  style="margin-left: 2px;">
                            <asp:TextBox ID="txtNoteBonus" TextMode="MultiLine" runat="server"></asp:TextBox>
                             <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtNoteBonus"
                                                        ErrorMessage="*" ValidationGroup="Register"></asp:RequiredFieldValidator>
                          </div>
                        </td>
                        </tr>
