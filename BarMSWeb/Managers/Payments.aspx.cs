...
public partial class Mangers_Payments : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int WeekNumber;
        ...
        if (uws.RowCount > 0)
        {
            for (int count = 0; count < uws.RowCount; count++)
            {
                ...
                if (uws.IDayNumber == 1)
                {
                    ...
                    if (Convert.ToBoolean(uws.GetColumn("bOnTime")))
        ...
        for (int Counter = 1; Counter <= 6; Counter++)
        {
            ...
            if (Counter == 1)
            {
                ...
                for (int salary = 1; salary <= 8; salary++)
                {
                    ...
                    if (salary == 8)
                    {
                        strSpan = "<span>" + totalSalary + "€</span>";
                        netSalary = totalSalary;
                    }
                    else
                    {
                        dr = dt.Select("iDayNumber = " + salary + "AND bOnTime = 1 AND bLate = 0");
                        if (dr.Length > 0)
                        {
                            ...
                            strSpan = "<span>" + PerDaySalary + "€</span>";
                        }
                        else
                        {
                            strSpan = "<span> 0€ </span>";
            ...
            else if (Counter == 4)
            {
                ...
                for (int advance = 1; advance <= 8; advance++)
                {
                    ...
                    if (advance == 8)
                    {
                        strSpan = "<span>-" + totalAdvance + "€</span>";
            ...
            else if (Counter == 5)
            {
                ...
                for (int penalty = 1; penalty <= 8; penalty++)
                {
                    ...
                    if (penalty == 8)
                    {
                        strSpan = "<span>" + totalPenalty + "€</span>";
                        if (totalPenalty != 0.0)
            ...
            else if (Counter == 6)
            {
                ...
                tdNetPayment.InnerHtml = (netSalary + netTips + netBonus - (netAdvances + netPanelty)).ToString() + "€";
                tr.Controls.Add(td);
        ...
        for (int note = 1; note <= 7; note++)
        {
            ...
            if (dr.Length > 0)
            {
                if (dr[0]["sNotes"].ToString() != "")
                {
                    ...
                    HtmlGenericControl bonusSpan = new HtmlGenericControl();
                    if (note == 1)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'> " + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Sunday)</span></span> <br />";
                    else if (note == 2)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Monday)</span></span> <br />";
                    else if (note == 3)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Tuesday)</span></span> <br />";
                    else if (note == 4)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Wednesday)</span></span> <br />";
                    else if (note == 5)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Thursday)</span></span> <br />";
                    else if (note == 6)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Friday)</span></span> <br />";
                    else if (note == 7)
                        bonusSpan.InnerHtml = "Manager " + managerName + ": <span style='font-weight:normal;'>" + dr[0]["sNotes"].ToString() + " <span style='color:gray;'>(Saturday)</span></span> <br />";
                    divNotes.Controls.Add(bonusSpan);
                }
            }
        }
