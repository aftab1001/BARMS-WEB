<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Test_ManagerDayOff.aspx.cs"
    MasterPageFile="~/MasterPages/ManagerMaster.master" Inherits="Managers_Test_ManagerDayOff" %>
                        ...
                        <tr>
                            <td>
                                <div style="background-color: #ea9999;">
                                    <asp:Label ID="lblManagerName" runat="server" Text="Manager Fist Name"></asp:Label>
                                </div>
                            </td>
                            <td>
                            ...
                            <td align="left" colspan="2">
                                <div class="textbox_small" style="float: left;">
                                    <asp:TextBox ID="txtTillDate" runat="server" CssClass="filter" Style="text-align: center;
                                        float: left;"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="reqtil" runat="server" ErrorMessage="*" ControlToValidate="txtTillDate"
