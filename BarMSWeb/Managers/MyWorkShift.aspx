<%@ Page Language="C#" MasterPageFile="~/MasterPages/ManagerMaster.master" AutoEventWireup="true"
    CodeFile="MyWorkShift.aspx.cs" Inherits="Managers_MyWorkShift" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="whitebox_centermiddlebg">
                ...
                <div id="Calendardate" style="margin-left: 312px;">
                </div>
            </td>
    ...
    <div style="float: left; text-align: center; margin-left: 254px;" class="bold_label">
    ...
    <div class="content_area_big">
        ...
        <div class="heading" >
            <a href="ManagerDayOff.aspx" style="float: left; text-decoration: underline; font-size: 12px;
                color: Blue;">Program a Day Off</a> 
                <asp:Label ID="lblSchedule" runat="server" Text="My Schedule" style="margin-left:263px;"></asp:Label>
                        ...
                        <table border="0" cellspacing="1" cellpadding="0" class="table_border">
                          <tr class="header_row">
                            ...
                            <tr class="alternate_row">
                                <td class="align_center">
                                    <asp:Label ID="lblUserSunday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkSunday" runat="server" Text="Present" AutoPostBack="true" OnCheckedChanged="chkSunday_Clicked"
                                        Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserMonday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkMonday" runat="server" Text="Present" AutoPostBack="true" OnCheckedChanged="chkMonday_Clicked"
                                        Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserTuesday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkTuesday" runat="server" Text="Present" AutoPostBack="true" OnCheckedChanged="chkTuesday_Clicked"
                                        Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserWednesday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkWednesday" runat="server" Text="Present" AutoPostBack="true"
                                        OnCheckedChanged="chkWednesday_Clicked" Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserThursday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkThursday" runat="server" Text="Present" AutoPostBack="true"
                                        OnCheckedChanged="chkThursday_Clicked" Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserFriday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkFriday" runat="server" Text="Present" AutoPostBack="true" OnCheckedChanged="chkFriday_Clicked"
                                        Enabled="false" Checked="true" />
                                </td>
                                <td class="align_center">
                                    <asp:Label ID="lblUserSaturday" runat="server" Text="Day OFF" Style="display: none;"></asp:Label>
                                    <asp:CheckBox ID="chkSaturday" runat="server" Text="Present" AutoPostBack="true"
                                        OnCheckedChanged="chkSaturday_Clicked" Enabled="false" Checked="true" />
                                </td>
                            </tr>
                        </table>
                    </div>
