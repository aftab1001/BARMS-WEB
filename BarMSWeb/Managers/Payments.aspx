<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ManagerMaster.master"
    AutoEventWireup="true" CodeFile="Payments.aspx.cs" Inherits="Mangers_Payments" %>
...
//		});
    ...
    <div class="content_area_big">
        ...
        <table border="0" cellspacing="1" cellpadding="5" align="center">
            <tr>
                <td>
                    <asp:CheckBox ID="chkSalary" runat="server" Visible="false" AutoPostBack="true"
                        oncheckedchanged="chkSalary_CheckedChanged" />
                </td>
                <td>
