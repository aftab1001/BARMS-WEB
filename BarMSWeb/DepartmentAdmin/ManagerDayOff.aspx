<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master"
    AutoEventWireup="true" CodeFile="ManagerDayOff.aspx.cs" Inherits="DepartmentAdmin_ManagerDayOff" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td class="whitebox_centermiddlebg">
                        ...
                        <div style="margin: 0 auto; text-align: center;">
                            <span style="font-size: small; font-weight: bold; position: relative; right: 0px;">You
                                can’t select a date in the past!</span>
                        </div>
                        <div class="clear">
                        </div>
                    ...
                    <tr>
                        ...
                        <td class="whitebox_centermiddlebg">
                            <table cellpadding="0" cellspacing="5" width="100%">
                                ...
                                <tr id="trManagerName_line" runat="server" style="display: none;">
