<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master" AutoEventWireup="true" CodeFile="MyAccount.aspx.cs" Inherits="DepartmentAdmin_MyAccount" %>
...
<div id="divFeedbackWindow" style="display: none; position: absolute;">
    ...
    <div class="graybox_account">
                                        ...
                                        <tr>
                                            <td class="align_left_middle" colspan="2">
                                                <div class="textbox_repassword">
                                                    <asp:TextBox ID="txtReNewPassword" Text="" runat="server" TextMode="password" Style="margin-right: -14px;"></asp:TextBox>
        ...
        <div class="bottom_graybox_right">
            <asp:ImageButton ID="btnUpdate" runat="server" ImageUrl="../images/btn_update.png" ValidationGroup="Register"
