<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master" AutoEventWireup="true" CodeFile="ManageManagers.aspx.cs" Inherits="DepartmentAdmin_ManageManagers" %>
            ...
            <ContentTemplate>
                ...
                <div class="small-lightbox-content" style="background-color: White; text-align: center;">
                    <table cellpadding="3" cellspacing="3" border="0" width="60%" align="center">
                        <tr>
                            <td colspan="2">
                                <div id="divActiveDeactiveBonusMessage" runat="server" visible="false">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2">
                                <asp:ImageButton ID="imgBtnActiveBonus" runat="server" ImageUrl="~/Images/btn_submit.png"
