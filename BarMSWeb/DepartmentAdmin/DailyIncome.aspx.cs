...
public partial class DepartmentAdmin_DailyIncome : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int year;
    ...
    private void LoadSubtotals()
    {
        ...
        workshiftIncome.LoadCurrentIncomeTotalForAccountManager(day, selectedWeek, DepartmentID, year);
        ...
        reh.GetSubtotal(mydate.Day,selectedWeek, mydate.Month, mydate.Year);
        if (reh.RowCount > 0)
        {
            ...
            try
            {
                ...
                if (drv["fkSalaryTypeID"].ToString() != "")
                {
                    ...
                    if (Convert.ToInt32(drv["fkSalaryTypeID"]) == 1)
                    {
                        ...
                        WeeklySalary = contract.GetUserSeasonSalary(Convert.ToDateTime(datepicker.Text), Convert.ToInt32(drv["pkUserID"]), DepartmentID);
                    }
    ...
    {
        DepartmentAdmin_DailyIncome d = new DepartmentAdmin_DailyIncome();
