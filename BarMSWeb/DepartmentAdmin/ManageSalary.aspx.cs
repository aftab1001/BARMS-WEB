...
public partial class DepartmentAdmin_ManageSalary : System.Web.UI.Page
{
    int pkUserID;
    int SalariedUserID;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Session["UserLogin"] != null)
        {
            ...
            if (!IsPostBack)
            {
                string strPreviousPage = Request.UrlReferrer.AbsolutePath;
                lnkBack.PostBackUrl =  strPreviousPage;
