<%@ Page Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master" AutoEventWireup="true"
    CodeFile="ManageUsers.aspx.cs" Inherits="DepartmentAdmin_ManageUsers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <tr>
    <td colspan="3">
    <div style="margin-left: -303px; position: absolute;">
        <a href="BonusDoc.aspx" style="color: Blue; font-size: 15px;font-weight:normal;">Back</a>
    </div>
    </td>
    </tr>
        <tr>
            ...
            <td class="whitebox_centermiddlebg">
                <div class="rounded_box">
                    ...
                    <asp:UpdatePanel ID="upnlRefreshUsers" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:GridView ID="grdUsers" runat="server" AutoGenerateColumns="false" AllowPaging="false"
