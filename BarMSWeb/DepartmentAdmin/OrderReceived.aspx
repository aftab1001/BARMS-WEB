<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master"
    AutoEventWireup="true" CodeFile="OrderReceived.aspx.cs" Inherits="DepartmentAdmin_OrderReceived" %>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Allow Edit">
                                        <ItemTemplate>
                                            ...
                                            <asp:HiddenField ID="hidBase" runat="server" Value="<%#Bind('pkBaseOrderID') %>" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
