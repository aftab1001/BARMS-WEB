...
public partial class DepartmentAdmin_ManageOrders : System.Web.UI.Page
{
    int UserID;
    ...
    protected void grdOrdersHistory_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //    lblDue.Text = "-";
                //else
                lblDue.Text = commonMethods.ChangetToUK(sDueAmt) + " €";
                    ...
                    for (int j = 0; j < grdOrders_FinalOrder.Rows.Count; j++)
                    {
                        ...
                        if (txtQty.Text != "" && txtQty.Text != "00,00" && txtQty.Text != "0")
                        {
                            ...
                            if (ViewState["OrderID"] != null)
                            {
                                ...
                                orderDetail.ProudctPrice = Convert.ToDouble(lblPrice.Text);
                                orderDetail.Vat = Convert.ToInt32(lblVat.Text.Replace("%", ""));
                                orderDetail.AfterVat = Convert.ToDouble(lblAfterVat.Text.Replace("€", ""));
