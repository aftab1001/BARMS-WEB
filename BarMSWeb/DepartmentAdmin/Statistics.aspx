    ...
    <script type="text/javascript">
      function ActiveTab() {
        ...
        function printreport() {
            ...
            var a = window.open("../DepartmentAdmin/PrintStats.aspx", 'print', 'status=0,toolbar=0,location=0,scrollbars = 1,resizable=1,menubar=0,width=700,height=700');

        }
        function pdfReport() {
            var txtParam = document.getElementById("ctl00_ContentPlaceHolder1_txtParams");
            var a = window.open("../DepartmentAdmin/PrintStats.aspx?r=ps", 'print', 'status=0,toolbar=0,location=0,scrollbars = 1,resizable=1,menubar=0,width=700,height=700');
