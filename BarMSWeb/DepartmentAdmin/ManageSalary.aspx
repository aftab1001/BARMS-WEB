<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master"
    AutoEventWireup="true" CodeFile="ManageSalary.aspx.cs" Inherits="DepartmentAdmin_ManageSalary" %>
 ...
 <script src="../JavaScript/jquery.watermark.js" type="text/javascript"></script>
    ...
    <div>
        <table border="0" cellpadding="2" cellspacing="2" width="100%">
            <tr>
                <td>
                    <asp:LinkButton ID="lnkBack" runat="server" Text="Go Back" ForeColor="Blue" style="text-decoration: underline;"
