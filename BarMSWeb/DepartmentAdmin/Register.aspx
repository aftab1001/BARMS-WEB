<%@ Page Language="C#" MasterPageFile="~/MasterPages/DepartmentAdminMaster.master"
    AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="DepartmentAdmin_Register" %>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" width="48%">
                                                            ...
                                                            <tr>
                                                                <td class="width45percent" style="width: 3%;">
                                                                    <div class="textbox204">
                                                                        <asp:DropDownList ID="ddlSpecialtyUpdate" runat="server" AutoPostBack="false">
                                                                        </asp:DropDownList>
                                                                    </div>
                                                                </td>
                                                                <td class="width55percent">
