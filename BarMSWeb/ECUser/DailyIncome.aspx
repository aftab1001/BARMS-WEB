<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ECUserMaster.master"
    AutoEventWireup="true" CodeFile="DailyIncome.aspx.cs" Inherits="ECUser_DailyIncome" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="display: none;"
        ...
        <tr>
            ...
            <td class="whitebox_centermiddlebg" style="width: 836px;">
                ...
                <td colspan="7" valign="top">
                    ...
                    <div style="float: left; width: 880px; text-align: center; margin-top: 10px;" class="bold_label">
                        <%--<asp:UpdatePanel ID="upnlDate" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>--%>
                        <asp:Label ID="lblWeek" Font-Bold="true" runat="server" Text=""></asp:Label><br />
                        <asp:Label ID="attendenceMsg" runat="server"></asp:Label>
                        <%--</ContentTemplate>
                        </asp:UpdatePanel>--%>
                    </div>
                                                                                            ...
                                                                                            <div style="float: left; width: 830px;">
                                                                                                ...
                                                                                                <div style="float: right; position: relative;">
                                                                                                    <asp:ImageButton ID="imgBtnAddTempIncome" runat="server" ImageUrl="~/Images/askfornewincometype.png"
                                                                                                        Style="display: none;" OnClick="imgBtnAddTempIncome_Click" />
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                            ...
                                                                                            <div style="float: left; width: 830px;">
                                                                                                ...
                                                                                                <div style="float: right; position: relative;">
                                                                                                    <asp:ImageButton ID="imgBtnAddNewExpenseType" runat="server" ImageUrl="~/Images/askfornewexpensetype.png"
                                                                                                        Style="display: none;" OnClick="imgBtnAddNewExpenseType_Click" />
                                                                                                </div>
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                        ...
                                                                                        <td align="right">
                                                                                            ...
                                                                                            <div style="float: right;">
                                                                                                <asp:ImageButton ID="imgBtnSaveRegisterValueTop" runat="server" ImageUrl="~/Images/btn_save.png"
                                                                                                    OnClick="imgBtnSaveRegisterValueTop_Click" />
                                                                                            </div>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
