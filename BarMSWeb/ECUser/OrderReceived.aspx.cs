...
public partial class ECUser_OrderReceived : System.Web.UI.Page
{
    static int call = 0;
    int UserID;
                    ...
                    case "cash":
                        ...
                        if (b.RowCount > 0)
                        {
                            if (txtcash.Text != "00,00" && txtcash.Text != "0" && txtcash.Text != "")
                            {
                                ...
                                url = " <a href=\'http://" + Request.ServerVariables["HTTP_HOST"].ToString() + "/bms/AccountManager/orderreceived.aspx?orderid=" + lnkOrderIDUpdate.CommandArgument + "&userid=" + ddlusers.SelectedValue + "\'>Click Here to go to order receiving page.</a>";
                                userIn.SMessage = url;
