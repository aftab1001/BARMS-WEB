...
public partial class ECUser_Payments : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int WeekNumber;
    ...
    protected void lnkPrevious_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../ECUser/Payments.aspx?week=" + WeekNumber + "&year=" + Year);
    }
    ...
    protected void btnGO_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../ECUser/Payments.aspx?week=" + WeekNumber + "&year=" + Convert.ToDateTime(datepicker.Text).Year + "&day=" + days);
