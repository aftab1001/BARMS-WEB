<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master"
    ...
    Inherits="AccountManager_ManageSupplier" %>
                                                                                            ...
                                                                                            <ItemTemplate>
                                                                                                <asp:GridView ID="grdInvoices" runat="server" GridLines="None" ShowHeader="false"
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <asp:TemplateField>
                                                                                                            <ItemTemplate>
                                                                                                                <asp:Label ID="lblNonInvSum" runat="server" Text="<%#Bind('NonInvoiceAmount') %>"></asp:Label>
                                                                                                            </ItemTemplate>
                                                                                                        </asp:TemplateField>
                                                                                                    </Columns>
                                                                                                </asp:GridView>
                            ...
                            <td>
                                <div class="textbox204_message">
                                    <asp:TextBox ID="txtSubject" runat="server" Style="border-style: none; border-color: inherit;
                                        ...
                                        font-size: 12px; margin-top: 8px;" ValidationGroup="reqmes"> </asp:TextBox></div>
