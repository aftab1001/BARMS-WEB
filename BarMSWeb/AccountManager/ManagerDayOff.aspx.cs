...
public partial class AccountManager_ManagerDayOff : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int WeekNumber;
    ...
    private void GetManagerName(int iUserID)
    {
        ...
        if (u.RowCount > 0)
        {
            tblColorCodes objColor = new tblColorCodes();
            objColor.GetColor(iUserID);
            divManagerDayOff.Style.Add("background-color", objColor.s_ColorCode);
    ...
    protected void dlColorCodes_RowDataBound(object sender, DataListItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            Label lblManagernameCode = (Label)e.Item.FindControl("lblManagernameCode");
            ...
            lblManagernameCode.Text = objusers.s_SFirstName + " " + objusers.s_SLastName;
