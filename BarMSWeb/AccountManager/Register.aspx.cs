...
public partial class AccountManager_Register : System.Web.UI.Page
{
    static int UserID;
    ...
    private void GetSpecialUsers()
    {
        ...
        u.GetSpecialUsersBySpeciality(DepartmentID);
    ...
    {
        if (ViewState["ddlSpecialtyUpdate"] != null)
        {
            if (CheckSpecialityExist(Convert.ToInt32(ViewState["ddlSpecialtyUpdate"])))
            {
                tblUserSpeciality special = new tblUserSpeciality();
                special.AddNew();
                special.s_FkSpecialityTypeID = ViewState["ddlSpecialtyUpdate"].ToString();
            ...
            ViewState["ddlSpecialtyUpdate"] = null;
        }
        else if (CheckSpecialityExist(Convert.ToInt32(ddlSpeciality.SelectedValue)))
        {
            tblUserSpeciality special = new tblUserSpeciality();
            special.AddNew();
            special.s_FkSpecialityTypeID = ddlSpeciality.SelectedValue;
    ...
    protected void ddlSpecialtyUpdate_SelectedIndexChanged(object sender, EventArgs e)
    {
        ViewState["ddlSpecialtyUpdate"] = ddlSpecialtyUpdate.SelectedValue;
        upnlSpecialty.Update();
    }
    //#region Removing base address of facebook and twitter
    //private string filterFacebookURL(string facebookURL)
