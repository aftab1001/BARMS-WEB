<%@ Page Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master" AutoEventWireup="true" CodeFile="ManageManager.aspx.cs" Inherits="AccountManager_ManageManager"  %>
        ...
        <tr>
            ...
            <td class="whitebox_centermiddlebg">
                <div style="margin: 0 auto; text-align: center;">
                    <asp:Label ID="Label6" runat="server" Font-Bold="true" Font-Size="Medium" Text="Manage Work Shifts Manager"></asp:Label></div>
                <%--<div class="clear_30">
                </div>--%>
