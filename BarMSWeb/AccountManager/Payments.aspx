<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master"
    AutoEventWireup="true" CodeFile="Payments.aspx.cs" Inherits="AccountManager_Payments" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Button ID="btnReload" runat="server" OnClick="btnReload_Click" UseSubmitBehavior="false"
        Style="display: none;" />
        ...
        <table width="100%">
            <tr>
                <td colspan="7" valign="top">
                    ...
                    <asp:UpdatePanel ID="upWeekLabel" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div style="float: left; width: 915px; text-align: center; margin-top: 10px;" class="bold_label">
                                                    ...
                                                    <td valign="top">
                                                        <div style="background-color: Transparent; width: 860px;">
                                                            <div style="background-color: Transparent; width: 860px; float: left;">
                                                                <div onclick="reloadValues()" style="background-color: #BFB8BB; width: 150px; height: 40px;
                                                                    line-height: 36px; float: left; margin-right: 5px; text-align: center; cursor: pointer;"
                                                                    class="tab1">
                                                                    Reference</div>
                                                            ...
                                                            <div style="background-color: Transparent; width: 860px; float: left;">
                                                                <div id="divTab1" runat="server" style="background-color: Transparent; border: solid 2px #c7c7c7;
                                                                                                            ...
                                                                                                            <Columns>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="Total Salaries" ItemStyle-Width="130" ItemStyle-HorizontalAlign="Right">
                                                                                                                    <ItemTemplate>
                                                                                                                        ...
                                                                                                                        <asp:Label ID="lblTotalSalaries" runat="server" Style="position: relative; margin-right: 40px;"></asp:Label>
                                                                                                                    </ItemTemplate>
                                                                                                                </asp:TemplateField>
                                                                                                                ...
                                                                                                                <asp:TemplateField HeaderText="Allow Edit" ItemStyle-HorizontalAlign="Right" Visible="false">
                                                                                                                    <ItemTemplate>
                                                                    ...
                                                                    <asp:UpdateProgress ID="upProgressPopUp" runat="server" AssociatedUpdatePanelID="upnlReference">
                                                                        <ProgressTemplate>
                                                                            <div id="imgloadar" class="loader" style="position: relative; margin-left: 365px;
                                                                                bottom: 200px;">
