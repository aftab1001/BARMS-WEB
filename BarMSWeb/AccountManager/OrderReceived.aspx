<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master"
    AutoEventWireup="true" CodeFile="OrderReceived.aspx.cs" Inherits="AccountManager_OrderReceived" %>
    ...
    <div>
        <asp:MultiView ID="mvMain" runat="server" ActiveViewIndex="1">
            ...
            <asp:View ID="vFinalOrders" runat="server">
             <asp:Label ID="lblOrderStatus" runat="server" Style="color: Green; font-size: 15px;
                    margin-left: 286px; "></asp:Label>
