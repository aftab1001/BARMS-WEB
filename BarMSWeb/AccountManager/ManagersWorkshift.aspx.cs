...
public partial class AccountManager_ManagersWorkshift : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int WeekNumber;
    ...
    protected void btnGO_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../AccountManager/ManagersWorkshift.aspx?week=" + WeekNumber + "&year=" + Convert.ToDateTime(datepicker.Text).Year + "&day=" + days);
    ...
    {
        Response.Redirect("../AccountManager/ManagersWorkshift.aspx?week=" + WeekNumber + "&year=" + Year + "&day=" + Day);
    }
    ...
    //{
    //    LinkButton lnkName = (LinkButton)grdSundayECUser.Rows[0].FindControl("lnkName");
    //}
}
