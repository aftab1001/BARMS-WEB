<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintReceipts.aspx.cs" Inherits="AccountManager_PrintReceipts" EnableEventValidation="false" %>
            ...
            <tr>
                <td>
                    <asp:GridView ID="grdReceipts" runat="server" AutoGenerateColumns="false" GridLines="None"
                        OnRowDataBound="grdReceipts_RowDataBound" Style="width: 100%; display: none;">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <table style="width: 700px; height: 424px; vertical-align: top;" cellpadding="0"
                                        ...
                                        <tr>
                                            <td colspan="2" align="right">
                                                ...
                                                <div style="width: 100%; height: 5px; background-color: Gray;">
                                                </div>--%>
                                            </td>
                                        </tr>
                                        <tr>
                    ...
                    <CR:CrystalReportViewer ID="CRVRecipt" runat="server" AutoDataBind="false" />
                </td>
            </tr>
        </table>
    </div>
