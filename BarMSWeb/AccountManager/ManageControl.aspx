<%@ Page Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master" AutoEventWireup="true" CodeFile="ManageControl.aspx.cs" Inherits="AccountManager_ManageControl"  %>
        ...
        <tr>
            ...
            <td class="whitebox_centermiddlebg">
                <div style="margin: 0 auto; text-align: center;">
                    <asp:Label ID="Label6" runat="server" Font-Bold="true" Font-Size="Medium" Text="Manage Work Shifts Control"></asp:Label></div>
                <%--<div class="clear_30">
                </div>--%>
                <div style="height:30px;color: Blue;font-size: 15px;"><a style="color:Blue;font-size:15px;" href="ManageWorkShift.aspx">Back Manage Work Shifts</a></div>
                <div class="clear"></div>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 15px; height: 141px; vertical-align: top;display:none;">
                                                                    M<br />
                                                                    a<br />
                                                                    n<br />
                                                                    a<br />
                                                            ...
                                                            <tr>
                                                                <td style="line-height: 15px; height: 100px;display:none;">
                                                                    O<br />
                                                                    t<br />
                                                                    h<br />
                                                                    e<br />
                                                    ...
                                                    <td valign="top">
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            ...
                                                            <tr class="alternate_row" style="display:none;">
                                                                <td class="align_left" valign="top" style="height: 105px;display:none">
                                                            ...
                                                            <tr>
                                                                <td colspan="7" style="background-color: Gray; height: 2px;display:none;">
                                                                </td>
                                                            </tr>
        ...
        <asp:UpdatePanel ID="upnlBonus" runat="server">
            <ContentTemplate>
                ...
                <div class="small-lightbox-content" style="background-color: White; text-align: center;">
                    ...
                    <tr>
                    <asp:Label runat="server" ID="lblMassage" Visible="false"></asp:Label>
                    </tr>
                        <tr>
                            <td>
                            ...
                            <td align="right">
                                <asp:ImageButton ID="imgBtnSaveAssignment" runat="server" ImageUrl="../images/btn_save_account.png"
                                    OnClick="imgBtnSaveAssignment_Click" />
                                     <asp:ImageButton ID="ImgbtnCancelAssignment" Visible="false" runat="server" ImageUrl="../images/btn_ok.png"
                                    OnClick="ImgbtnCancelAssignment_Click" />
