<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/AccountMaster.master"
    AutoEventWireup="true" CodeFile="ManagerDayOff.aspx.cs" Inherits="AccountManager_ManagerDayOff" %>
    ...
    <asp:UpdatePanel ID="upMain" runat="server">
        <ContentTemplate>
         ...
         <ajaxToolkit:CalendarExtender ID="extCalender" runat="server" Format="d" PopupPosition="bottomright" TargetControlID="datepicker" PopupButtonID="btnCalender"></ajaxToolkit:CalendarExtender>--%>
                    ...
                    <td class="whitebox_centermiddlebg">
                        <div style="margin: 0 auto; text-align: center;">
                            <asp:Label ID="Label6" runat="server" Font-Bold="true" Font-Size="Medium" Style="position: relative;
                                right: 0px;" Text="Manage Day Off"></asp:Label></div>
                        <div class="clear_30">
                        </div>
                       ...
                       <div style="margin: 0 auto; text-align: center;">
                            <span style="font-size:small; font-weight:bold;position:relative; right: 0px;" >You can’t select a date in the past!</span>
                                </div>
                        <div class="clear">
                        </div>
            ...
            <div style="float: left">
                <a href="MyWorkShift.aspx" style="float: left; text-decoration: underline; font-size: 12px;
                    font-weight: bold; color: blue;">Go to MyWorkShift</a>
            </div>
                        ...
                        <td class="whitebox_centermiddlebg">
                            <table cellpadding="0" cellspacing="5" width="100%">
                                <tr id="trManagerName" runat="server">
                                    <td>
                                        <div id="divManagerDayOff" runat="server" style="">
                                            <asp:Label ID="lblManagerName" runat="server" Text=""></asp:Label>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="textbox_small" style="float: left;">
                                            <asp:TextBox ID="txtDayOff" runat="server" CssClass="filter" onclick="javascript:disable_textbox(this.id);"
                                                Style="text-align: center; float: left;"></asp:TextBox>
                                    ...
                                    <td>
                                        <div class="dropdown" style="float: left;">
                                            <asp:TextBox ID="txtReason" runat="server" CssClass="filter" Enabled="false" Style="text-align: left;"></asp:TextBox>
                                        </div>
                                    </td>
                                    <td>
                ...
                <asp:DataList ID="dlColorCodes" runat="server" RepeatColumns="4" RepeatDirection="Horizontal"
                    ...
                    <ItemTemplate>
                        <div id="divColorCode" runat="server" style="width: 125px; height: 30px; text-align: center;
                            line-height: 2.5;">
                            <asp:Label ID="lblManagernameCode" runat="server"></asp:Label>
                        </div>
                    </ItemTemplate>
