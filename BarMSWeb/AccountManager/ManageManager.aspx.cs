...
public partial class AccountManager_ManageManager : System.Web.UI.Page
{
    int UserID;
    int DepartmentID;
    int WeekNumber;
    ...
    protected void btnGO_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("../AccountManager/ManageManager.aspx?week=" + WeekNumber + "&year=" + Convert.ToDateTime(datepicker.Text).Year + "&day=" + days);
    ...
    {
        Response.Redirect("../AccountManager/ManageManager.aspx?week=" + WeekNumber + "&year=" + Year + "&day=" + Day);
    }
