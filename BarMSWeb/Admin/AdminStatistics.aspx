<%@ Page Language="C#" MasterPageFile="~/MasterPages/AdminMaster.master" AutoEventWireup="true" CodeFile="AdminStatistics.aspx.cs" Inherits="Admin_AdminStatistics"  %>
...
display:none !important;
    ...
    <script type="text/javascript">
      function ActiveTab() {
            ...
            document.getElementById("MyWorkShifts").className = "Active_Home";
             document.getElementById("MyWorkShifts1").className = "Active_Home";
             document.getElementById("MyPayments").className = "Active_Home";
             document.getElementById("ctl00_ankMessages").className = "Active_Home";
             document.getElementById("MyContract").className = "Active_Home";
             document.getElementById("ankMessages1").className = "Active_Home";
        ...
        function printreport() {
            ...
            var a = window.open("../Admin/PrintStats.aspx", 'print', 'status=0,toolbar=0,location=0,scrollbars = 1,resizable=1,menubar=0,width=700,height=700');

        }
        function pdfReport() {
            var txtParam = document.getElementById("ctl00_ContentPlaceHolder1_txtParams");
            var a = window.open("../Admin/PrintStats.aspx?r=ps", 'print', 'status=0,toolbar=0,location=0,scrollbars = 1,resizable=1,menubar=0,width=700,height=700');
        ...
        <fieldset style="background-color: White;">
                            ...
                            <td>
                                <fieldset>
                                    ...
                                    <asp:DataList ID="dtlPositions" runat="server" RepeatColumns="3">
                                        ...
                                        <FooterTemplate>
                                        <asp:Label ID="lblNot" Visible="false" runat="server" Text="text"></asp:Label><br />
            ...
            <div style="float: left; width: 100%;">
                <table width="100%" align="center">
                        ...
                        <td>
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <div class="textbox115">
                                            <asp:DropDownList ID="ddlStaffDepartment" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStaffDepartment_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </div>
                                </td>
                                    <td>
                    ...
                    <tr>
                    <td colspan="4">
                    <div id="divProducts" runat="server" visible="false" style="float: left; width: 100%;">
                    <div class="clear_10"></div>
                    <div style="background-color: Gray; height: 1px; width: 100%; float: left;">
            </div><div class="clear_10"></div>
                                ...
                                <div class="textbox115" style="float: left;margin-left:20px;">
                                ...
                                <div style="margin-left:18px;float:left;width:135px;">
                ...
                <table id="tblMain" style="width: 100%; height: 100%" border="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ImageButton ID="imgBtnMessageIcon" runat="server" ImageUrl="../Images/Message.png" OnClick="imgBtnMessageIcon_Click" />
                        </td>
                        <td>
                        ...
                        <tr>
                            <td colspan="5">
                                <div id="chart_div" style="width: 900px; height: 500px;">
                                    <img id="imgGraph" runat="server" src="../Images/chart.jpg" />
                                </div>
                            </td>
                        </tr>
                    </table>
