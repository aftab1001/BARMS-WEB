...
{
	public abstract class _tblUserSpeciality : SqlClientEntity
	{
		public _tblUserSpeciality()
		{
			this.QuerySource = "tblUserSpeciality";
			this.MappingName = "tblUserSpeciality";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblUserSpecialityLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int PkUserSpecialityID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.PkUserSpecialityID, PkUserSpecialityID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblUserSpecialityLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter PkUserSpecialityID
			{
				get
				{
					return new SqlParameter("@PkUserSpecialityID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            public const string PkUserSpecialityID = "pkUserSpecialityID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PkUserSpecialityID] = _tblUserSpeciality.PropertyNames.PkUserSpecialityID;
					ht[FkUserID] = _tblUserSpeciality.PropertyNames.FkUserID;
					ht[FkSpecialityTypeID] = _tblUserSpeciality.PropertyNames.FkSpecialityTypeID;
					ht[BIsPrimary] = _tblUserSpeciality.PropertyNames.BIsPrimary;
					ht[DCreateDate] = _tblUserSpeciality.PropertyNames.DCreateDate;
					ht[DModifiedDate] = _tblUserSpeciality.PropertyNames.DModifiedDate;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PkUserSpecialityID] = _tblUserSpeciality.ColumnNames.PkUserSpecialityID;
					ht[FkUserID] = _tblUserSpeciality.ColumnNames.FkUserID;
					ht[FkSpecialityTypeID] = _tblUserSpeciality.ColumnNames.FkSpecialityTypeID;
					ht[BIsPrimary] = _tblUserSpeciality.ColumnNames.BIsPrimary;
					ht[DCreateDate] = _tblUserSpeciality.ColumnNames.DCreateDate;
					ht[DModifiedDate] = _tblUserSpeciality.ColumnNames.DModifiedDate;
		...
		{  
            public const string PkUserSpecialityID = "s_PkUserSpecialityID";
		...
		public virtual int PkUserSpecialityID
	    {
			get
	        {
				return base.Getint(ColumnNames.PkUserSpecialityID);
			}
			set
	        {
				base.Setint(ColumnNames.PkUserSpecialityID, value);
			}
		}
		...
		public virtual string s_PkUserSpecialityID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.PkUserSpecialityID) ? string.Empty : base.GetintAsString(ColumnNames.PkUserSpecialityID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.PkUserSpecialityID);
				else
					this.PkUserSpecialityID = base.SetintAsString(ColumnNames.PkUserSpecialityID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter PkUserSpecialityID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.PkUserSpecialityID, Parameters.PkUserSpecialityID);
			...
			public WhereParameter PkUserSpecialityID
		    {
				get
		        {
					if(_PkUserSpecialityID_W == null)
	        	    {
						_PkUserSpecialityID_W = TearOff.PkUserSpecialityID;
					}
					return _PkUserSpecialityID_W;
				}
			}
			...
			private WhereParameter _PkUserSpecialityID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter PkUserSpecialityID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.PkUserSpecialityID, Parameters.PkUserSpecialityID);
			...
			private AggregateParameter _PkUserSpecialityID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblUserSpecialityInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.PkUserSpecialityID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblUserSpecialityUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblUserSpecialityDelete]";
	
			SqlParameter p;
			p = cmd.Parameters.Add(Parameters.PkUserSpecialityID);
			p.SourceColumn = ColumnNames.PkUserSpecialityID;
