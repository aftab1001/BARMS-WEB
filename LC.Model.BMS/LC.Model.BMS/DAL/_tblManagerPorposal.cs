...
{
	public abstract class _tblManagerPorposal : SqlClientEntity
	{
		public _tblManagerPorposal()
		{
			this.QuerySource = "tblManagerPorposal";
			this.MappingName = "tblManagerPorposal";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblManagerPorposalLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int PkUserContratctID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_tblManagerPorposalLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter SPorposalText
			{
				get
				{
					return new SqlParameter("@SPorposalText", SqlDbType.NText, 1073741823);
				}
			}
			
			public static SqlParameter BActiveByManager
			{
				get
				{
					return new SqlParameter("@BActiveByManager", SqlDbType.Bit, 0);
				}
			}
			
			public static SqlParameter BApprovedByAdmin
			{
				get
				{
					return new SqlParameter("@BApprovedByAdmin", SqlDbType.Bit, 0);
				}
			}
		...
		{  
            ...
            public const string SPorposalText = "sPorposalText";
            public const string BActiveByManager = "bActiveByManager";
            public const string BApprovedByAdmin = "bApprovedByAdmin";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[PkUserContratctID] = _tblManagerPorposal.PropertyNames.PkUserContratctID;
					ht[FkUserID] = _tblManagerPorposal.PropertyNames.FkUserID;
					ht[SPorposalText] = _tblManagerPorposal.PropertyNames.SPorposalText;
					ht[BActiveByManager] = _tblManagerPorposal.PropertyNames.BActiveByManager;
					ht[BApprovedByAdmin] = _tblManagerPorposal.PropertyNames.BApprovedByAdmin;
					ht[FkSalaryTypeID] = _tblManagerPorposal.PropertyNames.FkSalaryTypeID;
					ht[DEmploymentFromDate] = _tblManagerPorposal.PropertyNames.DEmploymentFromDate;
					ht[DEmploymentEndDate] = _tblManagerPorposal.PropertyNames.DEmploymentEndDate;
					ht[LowSeasonSalary] = _tblManagerPorposal.PropertyNames.LowSeasonSalary;
					ht[HighSeasonSalary] = _tblManagerPorposal.PropertyNames.HighSeasonSalary;
					ht[StandardSalary] = _tblManagerPorposal.PropertyNames.StandardSalary;
					ht[FSalaryPercentage] = _tblManagerPorposal.PropertyNames.FSalaryPercentage;
					ht[MinimumPerday] = _tblManagerPorposal.PropertyNames.MinimumPerday;
					ht[PercentageOver] = _tblManagerPorposal.PropertyNames.PercentageOver;
					ht[BContractAgreed] = _tblManagerPorposal.PropertyNames.BContractAgreed;
					ht[DCreateDate] = _tblManagerPorposal.PropertyNames.DCreateDate;
					ht[DModifiedDate] = _tblManagerPorposal.PropertyNames.DModifiedDate;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[PkUserContratctID] = _tblManagerPorposal.ColumnNames.PkUserContratctID;
					ht[FkUserID] = _tblManagerPorposal.ColumnNames.FkUserID;
					ht[SPorposalText] = _tblManagerPorposal.ColumnNames.SPorposalText;
					ht[BActiveByManager] = _tblManagerPorposal.ColumnNames.BActiveByManager;
					ht[BApprovedByAdmin] = _tblManagerPorposal.ColumnNames.BApprovedByAdmin;
					ht[FkSalaryTypeID] = _tblManagerPorposal.ColumnNames.FkSalaryTypeID;
					ht[DEmploymentFromDate] = _tblManagerPorposal.ColumnNames.DEmploymentFromDate;
					ht[DEmploymentEndDate] = _tblManagerPorposal.ColumnNames.DEmploymentEndDate;
					ht[LowSeasonSalary] = _tblManagerPorposal.ColumnNames.LowSeasonSalary;
					ht[HighSeasonSalary] = _tblManagerPorposal.ColumnNames.HighSeasonSalary;
					ht[StandardSalary] = _tblManagerPorposal.ColumnNames.StandardSalary;
					ht[FSalaryPercentage] = _tblManagerPorposal.ColumnNames.FSalaryPercentage;
					ht[MinimumPerday] = _tblManagerPorposal.ColumnNames.MinimumPerday;
					ht[PercentageOver] = _tblManagerPorposal.ColumnNames.PercentageOver;
					ht[BContractAgreed] = _tblManagerPorposal.ColumnNames.BContractAgreed;
					ht[DCreateDate] = _tblManagerPorposal.ColumnNames.DCreateDate;
					ht[DModifiedDate] = _tblManagerPorposal.ColumnNames.DModifiedDate;
		...
		{  
            ...
            public const string SPorposalText = "s_SPorposalText";
            public const string BActiveByManager = "s_BActiveByManager";
            public const string BApprovedByAdmin = "s_BApprovedByAdmin";
		...
		public virtual string SPorposalText
	    {
			get
	        {
				return base.Getstring(ColumnNames.SPorposalText);
			}
			set
	        {
				base.Setstring(ColumnNames.SPorposalText, value);
			}
		}

		public virtual bool BActiveByManager
	    {
			get
	        {
				return base.Getbool(ColumnNames.BActiveByManager);
			}
			set
	        {
				base.Setbool(ColumnNames.BActiveByManager, value);
			}
		}

		public virtual bool BApprovedByAdmin
	    {
			get
	        {
				return base.Getbool(ColumnNames.BApprovedByAdmin);
			}
			set
	        {
				base.Setbool(ColumnNames.BApprovedByAdmin, value);
			}
		}
		...
		public virtual string s_SPorposalText
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.SPorposalText) ? string.Empty : base.GetstringAsString(ColumnNames.SPorposalText);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.SPorposalText);
				else
					this.SPorposalText = base.SetstringAsString(ColumnNames.SPorposalText, value);
			}
		}

		public virtual string s_BActiveByManager
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.BActiveByManager) ? string.Empty : base.GetboolAsString(ColumnNames.BActiveByManager);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.BActiveByManager);
				else
					this.BActiveByManager = base.SetboolAsString(ColumnNames.BActiveByManager, value);
			}
		}

		public virtual string s_BApprovedByAdmin
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.BApprovedByAdmin) ? string.Empty : base.GetboolAsString(ColumnNames.BApprovedByAdmin);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.BApprovedByAdmin);
				else
					this.BApprovedByAdmin = base.SetboolAsString(ColumnNames.BApprovedByAdmin, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter SPorposalText
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.SPorposalText, Parameters.SPorposalText);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}

				public WhereParameter BActiveByManager
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.BActiveByManager, Parameters.BActiveByManager);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}

				public WhereParameter BApprovedByAdmin
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.BApprovedByAdmin, Parameters.BApprovedByAdmin);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter SPorposalText
		    {
				get
		        {
					if(_SPorposalText_W == null)
	        	    {
						_SPorposalText_W = TearOff.SPorposalText;
					}
					return _SPorposalText_W;
				}
			}
			...
			public WhereParameter BActiveByManager
		    {
				get
		        {
					if(_BActiveByManager_W == null)
	        	    {
						_BActiveByManager_W = TearOff.BActiveByManager;
					}
					return _BActiveByManager_W;
				}
			}
			...
			public WhereParameter BApprovedByAdmin
		    {
				get
		        {
					if(_BApprovedByAdmin_W == null)
	        	    {
						_BApprovedByAdmin_W = TearOff.BApprovedByAdmin;
					}
					return _BApprovedByAdmin_W;
				}
			}
			...
			private WhereParameter _SPorposalText_W = null;
			private WhereParameter _BActiveByManager_W = null;
			private WhereParameter _BApprovedByAdmin_W = null;
			...
			public void WhereClauseReset()
			{
				...
				_FkUserID_W = null;
				_SPorposalText_W = null;
				_BActiveByManager_W = null;
				_BApprovedByAdmin_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter SPorposalText
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.SPorposalText, Parameters.SPorposalText);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}

				public AggregateParameter BActiveByManager
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.BActiveByManager, Parameters.BActiveByManager);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}

				public AggregateParameter BApprovedByAdmin
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.BApprovedByAdmin, Parameters.BApprovedByAdmin);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _SPorposalText_W = null;
			private AggregateParameter _BActiveByManager_W = null;
			private AggregateParameter _BApprovedByAdmin_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblManagerPorposalInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblManagerPorposalUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_tblManagerPorposalDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.SPorposalText);
			p.SourceColumn = ColumnNames.SPorposalText;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.BActiveByManager);
			p.SourceColumn = ColumnNames.BActiveByManager;
			p.SourceVersion = DataRowVersion.Current;

			p = cmd.Parameters.Add(Parameters.BApprovedByAdmin);
			p.SourceColumn = ColumnNames.BApprovedByAdmin;
			p.SourceVersion = DataRowVersion.Current;
